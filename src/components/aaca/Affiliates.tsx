...
export default function Affiliates() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:max-w-5xl">
      <div className="pb-8 px-2 text-center">
        <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl pb-2">
          Affiliates
        </h2>
        <p className="text-xl text-gray-500">
          District affiliates as well as various chess organizations under AACA
        </p>
      </div>
      <ul className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        {affiliates_list.map((item) => (
          <li
            key={item.name}
              ...
              <div className="-mt-px flex divide-x divide-gray-200">
                ...
                <div className="-ml-px w-0 flex-1 flex">
                  ...
                  >
                    ...
                    <span className="ml-3">{item.phone}</span>
                  </a>
                </div>
              </div>
            </div>
