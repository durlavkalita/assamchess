            ...
            <div className="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
              ...
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">Maligaon, India, Assam</span>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">70027 71337</span>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">assamchess2016@gmail.com</span>
                </dd>
              </dl>
              <ul className="mt-8 flex space-x-12" role="list">
                <li>
                  <a
                    ...
                    href="https://www.facebook.com/Longliveassamchess/"
                  >
                ...
                <li>
                  <a
                    className="text-indigo-200 hover:text-indigo-100"
                    href="https://www.instagram.com/assamchessclub"
                  >
